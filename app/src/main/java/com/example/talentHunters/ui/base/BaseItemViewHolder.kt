...
import com.example.talentHunters.di.components.DaggerViewHolderComponent
import com.example.talentHunters.di.components.ViewHolderComponent
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as TalentHunterApplication).applicationComponent)
