...
import com.example.talentHunters.di.components.DaggerFragmentComponent
import com.example.talentHunters.di.components.FragmentComponent
...
abstract class BaseFragment<VM : BaseViewModel> : Fragment() {
    ...
    private fun buildFragmentComponent() =
        DaggerFragmentComponent
            .builder()
            .applicationComponent((context!!.applicationContext as TalentHunterApplication).applicationComponent)
