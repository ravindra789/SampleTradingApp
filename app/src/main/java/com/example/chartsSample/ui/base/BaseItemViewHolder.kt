...
import com.example.chartsSample.di.components.DaggerViewHolderComponent
import com.example.chartsSample.di.components.ViewHolderComponent
import com.example.chartsSample.di.modules.ViewHolderModule
import com.example.chartsSample.utils.display.Toaster
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as ChartsSampleApplication).applicationComponent)
