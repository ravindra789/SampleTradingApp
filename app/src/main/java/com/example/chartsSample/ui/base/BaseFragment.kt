...
import com.example.chartsSample.di.components.DaggerFragmentComponent
...
abstract class BaseFragment<VM : BaseViewModel> : Fragment() {
    ...
    private fun buildFragmentComponent() =
        DaggerFragmentComponent
            .builder()
            .applicationComponent((context!!.applicationContext as ChartsSampleApplication).applicationComponent)
