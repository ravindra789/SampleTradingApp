...
import com.example.challengers.di.components.DaggerViewHolderComponent
import com.example.challengers.di.components.ViewHolderComponent
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as BountyApplication).applicationComponent)
